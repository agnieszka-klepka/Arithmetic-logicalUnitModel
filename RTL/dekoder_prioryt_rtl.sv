...
module dekoder_priorytetowy(i_argA, o_result);
  ...
  input [2:0] i_argA;
  output [1:0] o_result;
  assign _0_ = i_argA[0] & ~(i_argA[1]);
  assign o_result[0] = _0_ | i_argA[2];
  assign o_result[1] = i_argA[2] | i_argA[1];
endmodule
...
module zliczanie1(i_argA, i_argB, o_result);
  ...
  assign _00_ = i_argA[1] & i_argA[0];
  assign _01_ = i_argA[1] | i_argA[0];
  assign _02_ = i_argB[0] ? _01_ : _00_;
